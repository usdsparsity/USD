...
def swin_t_sparse(*, weights: Optional[Swin_T_Weights] = Swin_T_Weights.IMAGENET1K_V1, pretrained=True, progress: bool = True, **kwargs: Any) -> SparseSwinTransformer:
    """
...
def swin_s_sparse(*, weights: Optional[Swin_S_Weights] = Swin_S_Weights.IMAGENET1K_V1, pretrained=True, progress: bool = True, **kwargs: Any) -> SparseSwinTransformer:
    """
...
def swin_b_sparse(*, weights: Optional[Swin_B_Weights] = Swin_B_Weights.IMAGENET1K_V1, pretrained=True, progress: bool = True, **kwargs: Any) -> SparseSwinTransformer:
    """
...
def swin_v2_t_sparse(*, weights: Optional[Swin_V2_T_Weights] = Swin_V2_T_Weights.IMAGENET1K_V1, pretrained=True, progress: bool = True, **kwargs: Any) -> SparseSwinTransformer:
    """
...
def swin_v2_s_sparse(*, weights: Optional[Swin_V2_S_Weights] = Swin_V2_S_Weights.IMAGENET1K_V1, pretrained=True, progress: bool = True, **kwargs: Any) -> SparseSwinTransformer:
    """
...
def swin_v2_b_sparse(*, weights: Optional[Swin_V2_B_Weights] = Swin_V2_B_Weights.IMAGENET1K_V1, pretrained=True, progress: bool = True, **kwargs: Any) -> SparseSwinTransformer:
    """
